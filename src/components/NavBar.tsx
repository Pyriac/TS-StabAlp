...
export default function NavBar() {
  ...
  return (
    ...
    <header className="mobile">
      ...
      <nav>
        <div onClick={handleMenuClick} className={`burger ${menuState === "menuNav-show" ? "open" : ""}`}>
            <span />
            <span />
            <span />
        </div>
        <div className={menuState} style={{ background: menuState === "menuNav-show" ? "#fff" : "none" }}>
  ...
  <nav className="desktopNav">
    <div className={`desktopLink ${page === "prestations" ? "active" : ""}`}>
  ...
  Prestations
    ...
    <div className={`desktopLink ${page === "innovations" ? "active" : ""}`}>
    <Link to="/innovations" onClick={() => setPage("innovations")}>
      {page === "innovations" ? (
          <img src={Project_Management_white} className="navLogo" alt="" />
            ) : (
    ...
    <div className={`desktopLink ${page === "realisations" ? "active" : ""}`}>
